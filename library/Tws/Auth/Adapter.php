    ...
    public function authenticate()
    {
        try {
            ...
            if($e->getMessage() == Model_User::AUTH_WRONG_PASSWORD) {
                return $this->createResult(Zend_Auth_Result::FAILURE_CREDENTIAL_INVALID, array(self::MSG_BAD_PASSWORD));
            }

            if($e->getMessage() == Model_User::AUTH_NOT_FOUND) {
                return $this->createResult(Zend_Auth_Result::FAILURE_IDENTITY_NOT_FOUND, array(self::MSG_NOT_FOUND));
            }
        }
    }
